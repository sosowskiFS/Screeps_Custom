                ...
                if (targetFlag.pos.roomName == creep.pos.roomName) {
                    ...
                    if (!didDismantle) {
                        ...
                        if (somethingNearby) {
                            ...
                            if (creep.pos.getRangeTo(somethingNearby) == 1 && somethingNearby.structureType != STRUCTURE_WALL && somethingNearby.structureType != STRUCTURE_CONTAINER && somethingNearby.structureType != STRUCTURE_EXTENSION && somethingNearby.structureType != STRUCTURE_RAMPART) {
                                didDismantle = true;
                            }
                        }
                    }
