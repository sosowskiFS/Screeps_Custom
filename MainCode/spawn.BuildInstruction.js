    ...
    run: function(spawn, instruction, params, energyIndex, thisRoom = '', params2 = '') {
        switch (instruction) {
            ...
            case 'assault':
                ...
                if (attackers.length < 4 && (attackers.length < healers.length || attackers.length == healers.length)) {
                    ...
                    if (Game.flags[spawn.room.name + "DoBoost"]) {
                        ...
                        if (Game.flags[spawn.room.name + "RangedStyle"]) {
                            ...
                            //Melee Style
                            attackerConfig = [TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, HEAL, HEAL, HEAL, HEAL, HEAL];
                        }
                    }
                ...
                } else if (healers.length < 4 && healers.length < attackers.length && healerlessAttackers.length) {
