        ...
        switch (instruction) {
                    ...
                    if (params2 != '') {
                        ...
                        if (creepPath.length) {
                            ...
                            if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                                ...
                                spawn.spawnCreep([MOVE, MOVE, MOVE, MOVE, MOVE, CLAIM], 'claimer_' + spawn.name, {
                                    memory: {
                                        priority: 'claimer',
                                        destination: params,
                                        path: creepPath
            ...
            case 'vandalize':
                ...
                if (vandals.length < 1) {
                    ...
                    if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                        Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                        spawn.spawnCreep([TOUGH, MOVE], 'vandal_' + spawn.name, {
                            memory: {
                                priority: 'vandal',
                                message: "Wew Lad"
                            }
            ...
            case 'construct':
                ...
                if (constructors.length < 3) {
                    ...
                    if (params2 != '') {
                        ...
                        if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                            Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                            spawn.spawnCreep(constructorConfig, 'constructor_' + spawn.name, {
                                memory: {
            ...
            case 'removeKebab':
                ...
                if (kebabers.length < 1) {
                    ...
                    if (params2 != '') {
                        ...
                        if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                            Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                            spawn.spawnCreep(kebabConfig, 'kebab_' + spawn.name, {
                                memory: {
            ...
            case 'tDrain':
                ...
                if (tDrainers.length < 1) {
                    ...
                    if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                        Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                        spawn.spawnCreep(drainCreep, 'drainer_' + spawn.name, {
                            memory: {
            ...
            case 'helper':
                ...
                if (helpers.length < 3) {
                    ...
                    if (params2 != '') {
                        ...
                        if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                            Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                            spawn.spawnCreep(helperConfig, 'helper_' + spawn.name, {
                                memory: {
                                    priority: 'helper',
                                    destination: params,
            ...
            case 'loot':
                ...
                if (looters.length < 3) {
                    ...
                    if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                        Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                        spawn.spawnCreep(looterConfig, 'looter_' + spawn.name, {
                            memory: {
                                priority: 'looter',
                                destination: params,
                                homeRoom: params2
            ...
            case 'trump':
                ...
                if (trumps.length < 3) {
                    ...
                    if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                        Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                        spawn.spawnCreep(trumpConfig, 'trump_' + spawn.name, {
                            memory: {
                                priority: 'trump',
                                destination: params,
                                homeRoom: params2
                ...
                if (attackers.length < 3 && (attackers.length < healers.length || attackers.length == healers.length)) {
                    ...
                    if (params2 != '') {
                        ...
                        if (creepPath.length) {
                            if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                                Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                                spawn.spawnCreep(attackerConfig, 'attacker_' + spawn.name, {
                                    memory: {
                    ...
                    if (healerlessAttackers.length) {
                        ...
                        if (configCost <= Memory.CurrentRoomEnergy[energyIndex] && attackerID != '') {
                            Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                            spawn.spawnCreep(healerConfig, 'healer_' + spawn.name, {
                                memory: {
                                    priority: 'asshealer',
                                    destination: params,
                                    homeRoom: spawn.room.name,
            ...
            case 'distract':
                ...
                if (distractors.length < 1) {
                    ...
                    if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                        Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                        spawn.spawnCreep(distractConfig, 'attacker_' + spawn.name, {
                            memory: {
                                priority: 'distractor',
                                destination: params,
                                homeRoom: spawn.room.name,
            ...
            case 'powerGather':
                ...
                if (powerAttackers.length < 1) {
                    ...
                    if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                        Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                        spawn.spawnCreep(powerAttackConfig, 'powerA_' + spawn.name, {
                            memory: {
                    ...
                    if (powerAttackers[0]) {
                        ...
                        if (configCost <= Memory.CurrentRoomEnergy[energyIndex] && attackerID != '') {
                            Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                            spawn.spawnCreep(healerConfig, 'powerH_' + spawn.name, {
                                memory: {
                                    priority: 'powerHeal',
                                    destination: params,
                                    homeRoom: spawn.room.name,
            ...
            case 'powerCollect':
                ...
                if (powerCollectors.length < params2) {
                    ...
                    if (configCost <= Memory.CurrentRoomEnergy[energyIndex]) {
                        Memory.CurrentRoomEnergy[energyIndex] = Memory.CurrentRoomEnergy[energyIndex] - configCost;
                        spawn.spawnCreep(powerCollectConfig, 'powerC_' + spawn.name, {
                            memory: {
