        ...
        if (thisRoom.controller.owner) {
            ...
            if (Memory.RoomsRun.indexOf(thisRoom.name) < 0) {
                ...
                if (thisRoom.controller.level < 8) {
                    ...
                    if (thisRoom.storage) {
                        drawPie(roomVis, Math.round(thisRoom.storage.store[RESOURCE_ENERGY]), thisRoom.storage.storeCapacity, 'Energy', getColourByPercentage(thisRoom.storage.store[RESOURCE_ENERGY] / thisRoom.storage.storeCapacity, true), 2, 1.5);                       
                    }
            ...
            if (Game.time % delay == 0 && Memory.NoSpawnNeeded.indexOf(thisRoom.name) < 0 && !Game.spawns[i].spawning) {
                ...
                if (Game.flags[thisRoom.name + "Ranger"]) {
                    spawn_BuildInstruction.run(Game.spawns[i], 'ranger', Game.flags[thisRoom.name + "Ranger"].pos.roomName, energyIndex, '', 'E30N43;E30N40;E21N40;E23N38;E24N38')
                }

                if (Game.flags[thisRoom.name + "Ranger2"]) {
                    spawn_BuildInstruction.run(Game.spawns[i], 'ranger2', Game.flags[thisRoom.name + "Ranger2"].pos.roomName, energyIndex, '', 'E30N43;E30N40;E21N40;E22N37')
                }
