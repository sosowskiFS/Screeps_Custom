        ...
        for (var i in Game.spawns) {
            ...
            if (Game.time % delay == 0 && Memory.NoSpawnNeeded.indexOf(thisRoom.name) < 0 && !Game.spawns[i].spawning) {
                ...
                if (Game.flags[thisRoom.name + "SendHelper"]) {
                    if (Game.flags["UseDefinedRoute"]) {
                        spawn_BuildInstruction.run(Game.spawns[i], 'helper', Game.flags[thisRoom.name + "SendHelper"].pos.roomName, '', 'E77N82;E76N82;E76N81;E75N81;E74N81');
                    } else {
                ...
                if (Game.flags["RemoveKebab"] && thisRoom.name == 'E77N83') {
                    spawn_BuildInstruction.run(Game.spawns[i], 'removeKebab', Game.flags["RemoveKebab"].pos.roomName, '', 'E77N81;E78N81;E78N80;E74N80;E70N80;E70N81;E69N81');
                }
