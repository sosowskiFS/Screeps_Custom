var spawn_BuildCreeps5 = {
    run: function(spawn, thisRoom, RoomCreeps, energyIndex) {
        ...
        let labWorkerMax = 0;
        let salvagerMax = 1;
        let min1 = RESOURCE_CATALYZED_UTRIUM_ACID;
        ...
        if (strExtractor[0] && thisRoom.terminal && strMineral[0] && (thisRoom.terminal.storeCapacity - 5000) > _.sum(thisRoom.terminal.store)) {
